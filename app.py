            ...
            while completed_images_count < count :
                ...
                if 'gemini' in  template_str.lower()  : # gemini
                    ...
                    if template_str == 'gemini_redraw':
                        gemini_prompt = gemini_text_lib("describe this image in details, only descibe what is seen visually! , especially the layout. start with 'square image aspect ratio of 1:1 of. if theres image on the text, mention it with text in original language :", model ="gemini-2.0-flash-exp-image-generation",
