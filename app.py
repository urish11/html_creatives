            ...
            for i in range(count):
                ...
                with st.spinner(f"Generating image {i + 1} for '{topic}'..."):
                    ...
                    if new_prompt : 
                        ...
                        image_prompt = chatGPT(
                                f"""Generate a  visual image description  15 words MAX for  {topic}  . think of a visually very enticing way of prompting the topic!! i want very high CTR. use very aggrevating engaging ideas. dont do the obvious   descriptions but very creative and unexpected""",
                                model='o1')
